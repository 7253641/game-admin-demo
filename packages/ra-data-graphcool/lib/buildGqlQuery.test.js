...
describe('buildGqlQuery', function () {
    ...
    it('returns the correct query for GET_LIST', function () {
        expect(graphql_1.print(buildGqlQuery_1.default(introspectionResults)(resource, react_admin_1.GET_LIST, queryType, params))).toEqual("query allCommand($foo: Int!) {\n  items: allCommand(foo: $foo) {\n    foo\n    linked {\n      foo\n    }\n    resource {\n      id\n    }\n  }\n  total: _allCommandMeta(foo: $foo) {\n    count\n  }\n}\n");
    });
    it('returns the correct query for GET_MANY', function () {
        expect(graphql_1.print(buildGqlQuery_1.default(introspectionResults)(resource, react_admin_1.GET_MANY, queryType, params))).toEqual("query allCommand($foo: Int!) {\n  items: allCommand(foo: $foo) {\n    foo\n    linked {\n      foo\n    }\n    resource {\n      id\n    }\n  }\n  total: _allCommandMeta(foo: $foo) {\n    count\n  }\n}\n");
    });
    it('returns the correct query for GET_MANY_REFERENCE', function () {
        expect(graphql_1.print(buildGqlQuery_1.default(introspectionResults)(resource, react_admin_1.GET_MANY_REFERENCE, queryType, params))).toEqual("query allCommand($foo: Int!) {\n  items: allCommand(foo: $foo) {\n    foo\n    linked {\n      foo\n    }\n    resource {\n      id\n    }\n  }\n  total: _allCommandMeta(foo: $foo) {\n    count\n  }\n}\n");
    });
